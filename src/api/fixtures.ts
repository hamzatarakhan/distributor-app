import type { Invoice, Order, Product, Profile, ReturnRecord, Visit } from './types';
...
export const products: Product[] = [
  { id: 1, name: 'Cola 330ml Can (24pk)', reference: 'BEV-COLA-24', uom: 'Case', price: 22, currency: 'JOD', vanStock: 40 },
  { id: 2, name: 'Spring Water 1.5L (6pk)', reference: 'BEV-H2O-6', uom: 'Case', price: 19.5, currency: 'JOD', vanStock: 15 },
  { id: 3, name: 'Energy Drink 250ml (12pk)', reference: 'BEV-NRG-12', uom: 'Case', price: 32, currency: 'JOD', vanStock: 25 },
  { id: 4, name: 'Orange Juice 1L (8pk)', reference: 'BEV-OJ-8', uom: 'Case', price: 28, currency: 'JOD', vanStock: 10 },
  { id: 5, name: 'Sparkling Lemonade 330ml (24pk)', reference: 'BEV-LEM-24', uom: 'Case', price: 24, currency: 'JOD', vanStock: 30 },
];
...
export const visits: Visit[] = [
  ...
  },
  {
    ...
    outcome: 'no_sale', note: 'Overstocked, will check back next week.',
  },
];
